...
static void		set_current_params(double point[3], t_cylinder *cyl, t_params *current)
{
	current->id = 3;
...
static void		set_equation(double eq[3], double o_c[3], double ray[3], t_cylinder *cyl)
{
...
static int		check_if_within_borders(double t, t_cylinder *cyl, double ray[3], double o_c[3])
{
