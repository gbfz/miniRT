...
// 'no intersection' flag
# define NO_INTERSECTION INT32_MAX

// defines for triangle_intersect readability
# define PVEC 0
# define QVEC 1
# define TVEC 2
# define U 0
...
// define for light falloff
# define FOG 1519.591837

// define for shadow bias exclusion
...
void		img_lstadd_back(t_img_lst **lst, t_img_lst *new_obj);
